...
#include "my_custom_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_custom_interfaces::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_custom_interfaces::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_custom_interfaces::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_custom_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_custom_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  return &my_custom_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_custom_interfaces, msg, Num)() {
  return &my_custom_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
