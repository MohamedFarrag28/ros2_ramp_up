...
#include "my_custom_interfaces/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_c.h"
...
using _AddThreeInts_Request__ros_msg_type = my_custom_interfaces__srv__AddThreeInts_Request;
...
static uint32_t _AddThreeInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_custom_interfaces__srv__AddThreeInts_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_custom_interfaces__srv__AddThreeInts_Request;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
static size_t _AddThreeInts_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_custom_interfaces__srv__AddThreeInts_Request(
...
using _AddThreeInts_Response__ros_msg_type = my_custom_interfaces__srv__AddThreeInts_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_custom_interfaces__srv__AddThreeInts_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_custom_interfaces__srv__AddThreeInts_Response;
    is_plain =
      (
...
static size_t _AddThreeInts_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_custom_interfaces__srv__AddThreeInts_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "my_custom_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_custom_interfaces/srv/add_three_ints.h"
